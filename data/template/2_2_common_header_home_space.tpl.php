...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1571043114, '2', './data/template/2_2_common_header_home_space.tpl.php', './template/ppc', 'common/header_home_space')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1571043114, '2', './data/template/2_2_common_header_home_space.tpl.php', './template/ppc', 'common/header_home_space')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1571043114, '2', './data/template/2_2_common_header_home_space.tpl.php', './template/ppc', 'common/header_home_space')
;?>
