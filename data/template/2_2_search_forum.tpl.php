...
0
|| checktplrefresh('./template/default/search/forum.htm', './template/default/search/header.htm', 1571042240, '2', './data/template/2_2_search_forum.tpl.php', './template/ppc', 'search/forum')
|| checktplrefresh('./template/default/search/forum.htm', './template/default/search/pubsearch.htm', 1571042240, '2', './data/template/2_2_search_forum.tpl.php', './template/ppc', 'search/forum')
|| checktplrefresh('./template/default/search/forum.htm', './template/default/search/thread_list.htm', 1571042240, '2', './data/template/2_2_search_forum.tpl.php', './template/ppc', 'search/forum')
|| checktplrefresh('./template/default/search/forum.htm', './template/default/search/footer.htm', 1571042240, '2', './data/template/2_2_search_forum.tpl.php', './template/ppc', 'search/forum')
|| checktplrefresh('./template/default/search/forum.htm', './template/default/common/header_common.htm', 1571042240, '2', './data/template/2_2_search_forum.tpl.php', './template/ppc', 'search/forum')
;?>
