...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1571043013, '2', './data/template/2_2_common_header_forum_forumdisplay.tpl.php', './template/ppc', 'common/header_forum_forumdisplay')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1571043013, '2', './data/template/2_2_common_header_forum_forumdisplay.tpl.php', './template/ppc', 'common/header_forum_forumdisplay')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1571043013, '2', './data/template/2_2_common_header_forum_forumdisplay.tpl.php', './template/ppc', 'common/header_forum_forumdisplay')
;?>
...
<!-- <h1 style="text-align: center">这是新的内容</h1> -->
