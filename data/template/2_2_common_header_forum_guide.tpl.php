...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1571042107, '2', './data/template/2_2_common_header_forum_guide.tpl.php', './template/ppc', 'common/header_forum_guide')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1571042107, '2', './data/template/2_2_common_header_forum_guide.tpl.php', './template/ppc', 'common/header_forum_guide')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1571042107, '2', './data/template/2_2_common_header_forum_guide.tpl.php', './template/ppc', 'common/header_forum_guide')
;?>
